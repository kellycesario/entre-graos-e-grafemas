...
export const elincTranslations: Record<'pt-BR' | 'en-US', ProjectsCTAProps> = {
  'pt-BR': {
    ...
    text: 'Mergulhe em uma jornada fascinante pelo universo da Linguística, na qual teoria e prática se encontram para explorar a Gramática Gerativa e a Linguística Cognitiva de forma colaborativa e inovadora',
    firstButtonLabel: 'Mais sobre o eLinC',
    secondButtonLabel: 'Visite o site oficial',
  },
  'en-US': {
    title: 'Learn about the eLinC project',
    text: 'Dive into a fascinating journey through Linguistics universe, where theory and practice meet to explore Generative Grammar and Cognitive Linguistics in a collaborative and innovative way',
